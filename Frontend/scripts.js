...
async function fetchTasks() {
  const res = await fetch('https://dwi-listatareas-xw3r.onrender.com:8800/actividades');
...
async function updateTask(id, task) {
  const res = await fetch(`https://dwi-listatareas-xw3r.onrender.com:8800/actividades/${id}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(task)
  });
